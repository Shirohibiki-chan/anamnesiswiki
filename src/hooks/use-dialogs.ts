...
import { fileManagerName, pickFolder, pickImportFile, pickLkSavePath, pickPageTemplateFile, pickPageTemplateSavePath, pickSingleMarkdownSavePath, pickWorldZipSavePath, previewSite, showFolder } from "../services/dialog-service";
...
export function useDialogs() {
  ...
  return {
    ...
    pickPageTemplateSavePath,
    pickPageTemplateFile,
