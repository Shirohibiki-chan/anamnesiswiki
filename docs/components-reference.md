...
| The `:` menu — glyphs from the catalogue, emoji from BlockNote's own list, and the rule that keeps `Note:` from opening it | `src/services/editor-blocks/icon-menu-items.tsx`, `icon-trigger.ts` |
